...
### Odd-Even Sort - Daniel Armenta
This is the final evaluation for OddEven Sort in terms of Strong Scaling, Strong Scaling Speedups, and Weak Scaling across various input sizes, input types, and sections of code (comp_large, comm, and main). It is worth mentioning that there was not enough credits on the Grace portal to run all of the MPI implementation examples.

CUDA - 
![Alt text](<OddEven/presentation/cuda1.png>)
For the CUDA implementation, we can see that the speed up for the strong comp section does really well and starts off by increasing as the number of threads increase up to a certain point. Slightly after 200 threads the speed up becomes constant at around 3 and 3.5. In the comp section for strong scaling, we can see that the algorithm does well. The time it takes to sort the array decreases as the number of threads increase up until a certain point in which it seems to stay constant. This is more than likely due to overhead in communication between the threads. However, we can see that the computation part performs bad for the weak scaling. This means that the workload is not being split evenly accross threads.

![Alt text](<OddEven/presentation/cuda2.png>)
In this graphs we can see that the speedup of the communication section stay aroud 1 for the majority of time on average. Lastly, we can see that the main section speeds up to 1.6 and stays constant around 1.5 for the majority of time. This is good when you compare it to the sequential version. 

MPI-

![Alt text](<OddEven/presentation/mpi1.png>)
For the MPI implementation, we can see that the speed up for the computation part performs really good. The speed up reaches above 7 with the input being random but the speed up stays around 4. We can also see that the strong scaling for computation generally takes less time as the number of processors increases. For the weak scaling of the comp section, we can see that it does not have a bad weak scaling. The load is being spread somewhat evenly accross the processors.

![Alt text](<OddEven/presentation/mpi2.png>)
For the speed up of the communication part though, we can see that it performs really bad. The speed up goes down as the number of processors increase. it almost reaches 0. The performance of the communication affects the main section as we can see from the other graph. Speed up of main also does really bad, similar to the comm graph. Overall, OddEven in MPI performs worst than its sequential part. This makes sense because the MPI implementation requires communication between processes at every iteration. 

Below are all of the plots for the strong and weak scaling for Main, comm and large comp for both MPI and CUDA.

### CUDA - Strong Scaling
![Alt text](<OddEven/CUDA/cuda_strong/0.png>)
![Alt text](<OddEven/CUDA/cuda_strong/1.png>)
![Alt text](<OddEven/CUDA/cuda_strong/2.png>)
![Alt text](<OddEven/CUDA/cuda_strong/3.png>)
![Alt text](<OddEven/CUDA/cuda_strong/4.png>)
![Alt text](<OddEven/CUDA/cuda_strong/5.png>)
![Alt text](<OddEven/CUDA/cuda_strong/6.png>)
![Alt text](<OddEven/CUDA/cuda_strong/7.png>)
![Alt text](<OddEven/CUDA/cuda_strong/8.png>)
![Alt text](<OddEven/CUDA/cuda_strong/9.png>)
![Alt text](<OddEven/CUDA/cuda_strong/10.png>)
![Alt text](<OddEven/CUDA/cuda_strong/11.png>)
![Alt text](<OddEven/CUDA/cuda_strong/12.png>)
![Alt text](<OddEven/CUDA/cuda_strong/13.png>)
![Alt text](<OddEven/CUDA/cuda_strong/14.png>)
![Alt text](<OddEven/CUDA/cuda_strong/15.png>)
![Alt text](<OddEven/CUDA/cuda_strong/16.png>)
![Alt text](<OddEven/CUDA/cuda_strong/17.png>)
![Alt text](<OddEven/CUDA/cuda_strong/18.png>)
![Alt text](<OddEven/CUDA/cuda_strong/19.png>)
![Alt text](<OddEven/CUDA/cuda_strong/20.png>)
![Alt text](<OddEven/CUDA/cuda_strong/21.png>)
![Alt text](<OddEven/CUDA/cuda_strong/22.png>)
![Alt text](<OddEven/CUDA/cuda_strong/23.png>)
![Alt text](<OddEven/CUDA/cuda_strong/24.png>)
![Alt text](<OddEven/CUDA/cuda_strong/25.png>)
![Alt text](<OddEven/CUDA/cuda_strong/26.png>)
![Alt text](<OddEven/CUDA/cuda_strong/27.png>)
![Alt text](<OddEven/CUDA/cuda_strong/28.png>)
![Alt text](<OddEven/CUDA/cuda_strong/29.png>)
![Alt text](<OddEven/CUDA/cuda_strong/30.png>)
![Alt text](<OddEven/CUDA/cuda_strong/31.png>)


### CUDA - Strong Scaling Speedup
![Alt text](<OddEven/CUDA/cuda_strong_speedup/0.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/1.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/2.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/3.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/4.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/5.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/6.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/7.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/8.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/9.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/10.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/11.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/12.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/13.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/14.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/15.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/16.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/17.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/18.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/19.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/20.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/21.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/22.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/23.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/24.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/25.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/26.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/27.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/28.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/29.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/30.png>)
![Alt text](<OddEven/CUDA/cuda_strong_speedup/31.png>)
### CUDA - Weak Scaling
![Alt text](<OddEven/CUDA/cuda_weak/0.png>)
![Alt text](<OddEven/CUDA/cuda_weak/1.png>)
![Alt text](<OddEven/CUDA/cuda_weak/2.png>)
![Alt text](<OddEven/CUDA/cuda_weak/3.png>)
![Alt text](<OddEven/CUDA/cuda_weak/4.png>)
![Alt text](<OddEven/CUDA/cuda_weak/5.png>)
![Alt text](<OddEven/CUDA/cuda_weak/6.png>)
![Alt text](<OddEven/CUDA/cuda_weak/7.png>)
![Alt text](<OddEven/CUDA/cuda_weak/8.png>)
![Alt text](<OddEven/CUDA/cuda_weak/9.png>)
![Alt text](<OddEven/CUDA/cuda_weak/10.png>)
![Alt text](<OddEven/CUDA/cuda_weak/11.png>)
![Alt text](<OddEven/CUDA/cuda_weak/12.png>)
![Alt text](<OddEven/CUDA/cuda_weak/13.png>)
![Alt text](<OddEven/CUDA/cuda_weak/14.png>)
![Alt text](<OddEven/CUDA/cuda_weak/15.png>)
![Alt text](<OddEven/CUDA/cuda_weak/16.png>)
![Alt text](<OddEven/CUDA/cuda_weak/17.png>)
![Alt text](<OddEven/CUDA/cuda_weak/18.png>)
![Alt text](<OddEven/CUDA/cuda_weak/19.png>)
![Alt text](<OddEven/CUDA/cuda_weak/20.png>)
![Alt text](<OddEven/CUDA/cuda_weak/21.png>)
![Alt text](<OddEven/CUDA/cuda_weak/22.png>)
![Alt text](<OddEven/CUDA/cuda_weak/23.png>)
![Alt text](<OddEven/CUDA/cuda_weak/24.png>)
![Alt text](<OddEven/CUDA/cuda_weak/25.png>)
![Alt text](<OddEven/CUDA/cuda_weak/26.png>)
![Alt text](<OddEven/CUDA/cuda_weak/27.png>)
![Alt text](<OddEven/CUDA/cuda_weak/28.png>)
![Alt text](<OddEven/CUDA/cuda_weak/29.png>)
![Alt text](<OddEven/CUDA/cuda_weak/30.png>)
![Alt text](<OddEven/CUDA/cuda_weak/31.png>)
### MPI - Strong Scaling
![Alt text](<OddEven/MPI/mpi_strong/0.png>)
![Alt text](<OddEven/MPI/mpi_strong/1.png>)
![Alt text](<OddEven/MPI/mpi_strong/2.png>)
![Alt text](<OddEven/MPI/mpi_strong/3.png>)
![Alt text](<OddEven/MPI/mpi_strong/4.png>)
![Alt text](<OddEven/MPI/mpi_strong/5.png>)
![Alt text](<OddEven/MPI/mpi_strong/6.png>)
![Alt text](<OddEven/MPI/mpi_strong/7.png>)
![Alt text](<OddEven/MPI/mpi_strong/8.png>)
![Alt text](<OddEven/MPI/mpi_strong/9.png>)
![Alt text](<OddEven/MPI/mpi_strong/10.png>)
![Alt text](<OddEven/MPI/mpi_strong/11.png>)
![Alt text](<OddEven/MPI/mpi_strong/12.png>)
![Alt text](<OddEven/MPI/mpi_strong/13.png>)
![Alt text](<OddEven/MPI/mpi_strong/14.png>)
![Alt text](<OddEven/MPI/mpi_strong/15.png>)
![Alt text](<OddEven/MPI/mpi_strong/16.png>)
![Alt text](<OddEven/MPI/mpi_strong/17.png>)
![Alt text](<OddEven/MPI/mpi_strong/18.png>)
![Alt text](<OddEven/MPI/mpi_strong/19.png>)
![Alt text](<OddEven/MPI/mpi_strong/20.png>)
![Alt text](<OddEven/MPI/mpi_strong/21.png>)
![Alt text](<OddEven/MPI/mpi_strong/22.png>)
![Alt text](<OddEven/MPI/mpi_strong/23.png>)
![Alt text](<OddEven/MPI/mpi_strong/24.png>)
![Alt text](<OddEven/MPI/mpi_strong/25.png>)
![Alt text](<OddEven/MPI/mpi_strong/26.png>)
![Alt text](<OddEven/MPI/mpi_strong/27.png>)
![Alt text](<OddEven/MPI/mpi_strong/28.png>)
![Alt text](<OddEven/MPI/mpi_strong/29.png>)
![Alt text](<OddEven/MPI/mpi_strong/30.png>)
![Alt text](<OddEven/MPI/mpi_strong/31.png>)
![Alt text](<OddEven/MPI/mpi_strong/32.png>)
![Alt text](<OddEven/MPI/mpi_strong/33.png>)
![Alt text](<OddEven/MPI/mpi_strong/34.png>)
![Alt text](<OddEven/MPI/mpi_strong/35.png>)
![Alt text](<OddEven/MPI/mpi_strong/36.png>)
![Alt text](<OddEven/MPI/mpi_strong/37.png>)
![Alt text](<OddEven/MPI/mpi_strong/38.png>)
![Alt text](<OddEven/MPI/mpi_strong/39.png>)
![Alt text](<OddEven/MPI/mpi_strong/40.png>)
![Alt text](<OddEven/MPI/mpi_strong/41.png>)
![Alt text](<OddEven/MPI/mpi_strong/42.png>)
![Alt text](<OddEven/MPI/mpi_strong/43.png>)
### MPI - Strong Scaling Speedup
![Alt text](<OddEven/MPI/mpi_strong_speedup/0.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/1.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/2.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/3.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/4.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/5.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/6.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/7.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/8.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/9.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/10.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/11.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/12.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/13.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/14.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/15.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/16.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/17.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/18.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/19.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/20.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/21.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/22.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/23.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/24.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/25.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/26.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/27.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/28.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/29.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/30.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/31.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/32.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/33.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/34.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/35.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/36.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/37.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/38.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/39.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/40.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/41.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/42.png>)
![Alt text](<OddEven/MPI/mpi_strong_speedup/43.png>)

### MPI - Weak Scaling
![Alt text](<OddEven/MPI/mpi_weak/0.png>)
![Alt text](<OddEven/MPI/mpi_weak/1.png>)
![Alt text](<OddEven/MPI/mpi_weak/2.png>)
![Alt text](<OddEven/MPI/mpi_weak/3.png>)
![Alt text](<OddEven/MPI/mpi_weak/4.png>)
![Alt text](<OddEven/MPI/mpi_weak/5.png>)
![Alt text](<OddEven/MPI/mpi_weak/6.png>)
![Alt text](<OddEven/MPI/mpi_weak/7.png>)
![Alt text](<OddEven/MPI/mpi_weak/8.png>)
![Alt text](<OddEven/MPI/mpi_weak/9.png>)
![Alt text](<OddEven/MPI/mpi_weak/10.png>)
![Alt text](<OddEven/MPI/mpi_weak/11.png>)
![Alt text](<OddEven/MPI/mpi_weak/12.png>)
![Alt text](<OddEven/MPI/mpi_weak/13.png>)
![Alt text](<OddEven/MPI/mpi_weak/14.png>)
![Alt text](<OddEven/MPI/mpi_weak/15.png>)
![Alt text](<OddEven/MPI/mpi_weak/16.png>)
![Alt text](<OddEven/MPI/mpi_weak/17.png>)
![Alt text](<OddEven/MPI/mpi_weak/18.png>)
![Alt text](<OddEven/MPI/mpi_weak/19.png>)
![Alt text](<OddEven/MPI/mpi_weak/20.png>)
![Alt text](<OddEven/MPI/mpi_weak/21.png>)
![Alt text](<OddEven/MPI/mpi_weak/22.png>)
![Alt text](<OddEven/MPI/mpi_weak/23.png>)
![Alt text](<OddEven/MPI/mpi_weak/24.png>)
![Alt text](<OddEven/MPI/mpi_weak/25.png>)
![Alt text](<OddEven/MPI/mpi_weak/26.png>)
![Alt text](<OddEven/MPI/mpi_weak/27.png>)
![Alt text](<OddEven/MPI/mpi_weak/28.png>)
![Alt text](<OddEven/MPI/mpi_weak/29.png>)
![Alt text](<OddEven/MPI/mpi_weak/30.png>)
![Alt text](<OddEven/MPI/mpi_weak/31.png>)
![Alt text](<OddEven/MPI/mpi_weak/32.png>)
![Alt text](<OddEven/MPI/mpi_weak/33.png>)
![Alt text](<OddEven/MPI/mpi_weak/34.png>)
![Alt text](<OddEven/MPI/mpi_weak/35.png>)
![Alt text](<OddEven/MPI/mpi_weak/36.png>)
![Alt text](<OddEven/MPI/mpi_weak/37.png>)
![Alt text](<OddEven/MPI/mpi_weak/38.png>)
![Alt text](<OddEven/MPI/mpi_weak/39.png>)
![Alt text](<OddEven/MPI/mpi_weak/40.png>)
![Alt text](<OddEven/MPI/mpi_weak/41.png>)
![Alt text](<OddEven/MPI/mpi_weak/42.png>)
![Alt text](<OddEven/MPI/mpi_weak/43.png>)
